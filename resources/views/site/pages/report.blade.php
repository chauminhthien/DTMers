...
<div class="services w3l wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
	...
	<div class="container">
		...
		<div class="contact-section">
				<h2 class="w3">RePort</h2>		
					<div class="contact-grids">
						<div class="col-md-12 contact-grid">
							
							<p>Cho chúng tôi biết lý do bạn báo cáo bài viết <strong style="color:orange">{{$post->name}}</strong></p>
							@if(count($errors) > 0)
	                        ...
	                        @endif
							<form action="report/{{$post->id}}/{{$post->nameKhongDau}}.html" method="post">
								<textarea type="text" name="lydo"  required=""></textarea>
