...
<div class="services w3l wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
	...
	<div class="container">
		...
		<div class="contact-section">
				<h2 class="w3" style="font-family:'T';">Sửa Thông Tin: {{$info->name}}</h2>		
					<div class="contact-grids">
						<div class="col-md-12 contact-grid">
	                        ...
	                        @endif
							<form action="user/sua-thong-tin-ca-nhan.html" method="post" enctype="multipart/form-data">
								<div class="form-group">
	                                <label>User Name </label>
	                                <input class="form-control" value="{{$info->name}}" required="required" name="name" placeholder="Vui Lòng Nhập Name Vào" />
	                            </div>
	                            <div class="form-group">
	                                <label>Email </label>
	                                <input type="email" disabled="" value="{{$info->email}}" class="form-control" name="email" placeholder="Vui Lòng Nhập Email Vào" style="width:100%;" />
	                            </div>
	                            <div class="form-group">
	                                <label>PassWord </label>
	                                <input type="password" class="form-control" name="pass" placeholder="Vui Lòng Nhập PassWrord Vào" />
	                            </div>
	                            <div class="form-group">
	                                <label>Ảnh Đại Diện </label><br/>
	                                <img src="upload/img_user/{{$info->img}}" width="150px"><br/><br/>
