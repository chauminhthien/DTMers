	...
	<div class="container">
		...
		<div class="tech-no">
			...
			@if(count($confessions) >0)
				<h2 style="font-family:'T'; color:orange;"> Confessions</h2>
			@foreach($confessions as $cfs)
				<div class="wthree">
					 <div class="col-md-6 wthree-left wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
						<div class="tch-img">
								<a title="{{$cfs->name}}" href="confessions/{{$cfs->id}}/{{$cfs->nameKhongDau}}.html"><img src="upload/cfs/cfs.jpg" class="img-responsive" alt="{{$cfs->name}}"></a>
								<div class="cfs_hidden">
									#{{$cfs->id}}
								</div>
						</div>
					 </div>
					 <div class="col-md-6 wthree-right wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
							<h3><a title="{{$cfs->name}}" href="confessions/{{$cfs->id}}/{{$cfs->nameKhongDau}}.html">{{$cfs->name}}</a></h3>
								<div class="bht1">
									<a title="{{$cfs->name}}" href="confessions/{{$cfs->id}}/{{$cfs->nameKhongDau}}.html">Read More</a>
								</div>
								<div class="soci">
									<ul>
			...
			@endforeach
			@else
				<h2 style="font-family:'T'; color:orange;">Chưa Có Confessions</h2>
			@endif
			<div class="col-lg-12"> 
					<ul class="pagination">
